...
struct Endpoints {
    ...
    static let EPISODE_URL: String = "https://rickandmortyapi.com/api/episode/?page=1"
    static let LOCATION_URL: String = "https://rickandmortyapi.com/api/location/?page=1"
}
